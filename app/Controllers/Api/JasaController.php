...
final class JasaController extends MasterDataController
{
    ...
    {
        return ['table' => 'jasa', 'label' => 'jasa', 'fields' => ['id_jasa','kategori_id','satuan_id','gambar_img','nama','harga','tgl_input','tgl_update'], 'writable' => ['id_jasa','kategori_id','satuan_id','gambar_img','nama','harga','tgl_input','tgl_update'], 'schema' => [
