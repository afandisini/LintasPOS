...
final class SupplierController extends MasterDataController
{
    ...
    {
        return ['table' => 'supplier', 'label' => 'supplier', 'filters' => ['email_supplier'], 'fields' => ['nama_supplier','alamat_supplier','telepon_supplier','email_supplier'], 'writable' => ['nama_supplier','alamat_supplier','telepon_supplier','email_supplier'], 'schema' => [
