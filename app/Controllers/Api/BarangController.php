...
final class BarangController extends MasterDataController
{
    ...
    {
        return ['table' => 'barang', 'label' => 'barang', 'fields' => ['id_barang','kategori_id','satuan_id','gambar','nama_barang','merk','harga_beli','harga_jual','stok','exp_date','tgl_input','tgl_update'], 'writable' => ['id_barang','kategori_id','satuan_id','gambar','nama_barang','merk','harga_beli','harga_jual','exp_date','tgl_input','tgl_update'], 'schema' => [
