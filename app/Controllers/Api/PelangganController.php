...
final class PelangganController extends MasterDataController
{
    ...
    {
        return ['table' => 'pelanggan', 'label' => 'pelanggan', 'fields' => ['kode_pelanggan','nama_pelanggan','alamat_pelanggan','telepon_pelanggan','email_pelanggan'], 'writable' => ['kode_pelanggan','nama_pelanggan','alamat_pelanggan','telepon_pelanggan','email_pelanggan'], 'schema' => [
